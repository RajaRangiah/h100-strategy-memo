...
**Business impact:**  
Compute drift silently raises inference COGS, degrades performance, and delays breakeven on H100 capital expenditure.
...
This ensures:
- Capital assets are protected from misuse
- AI services consistently receive the performance tier they were designed for
...
This policy directly protects capital efficiency and lowers inference cost at scale.
